...
function Header() {
  ...
  return (
    <header className="header-container pt-[12vh]">
      <div className="flex flex-row fixed top-0 left-[2.5%] w-[95vw] justify-between items-center h-[12vh] border border-black rounded-lg px-4 bg-[#f58439] z-50">
        <div className="logo">
          <Image
